...
Docs: https://cj-mills.github.io/cjm-transcription-coreboundaries.html.md"""

# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/boundaries.ipynb.

# %% auto #0
__all__ = ['compute_segment_boundaries']

# %% ../nbs/boundaries.ipynb #ae96007a
from typing import Dict, List, Optional

# %% ../nbs/boundaries.ipynb #0a81abcd
